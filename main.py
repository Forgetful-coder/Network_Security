...
if __name__=='__main__':
    try:
        ...
        model_trainer_config=ModelTrainerConfig(training_pipleine_config)
        model_trainer=ModelTrainer(model_trainer_config=model_trainer_config,data_transformation_artifact=data_transformation_arti)
